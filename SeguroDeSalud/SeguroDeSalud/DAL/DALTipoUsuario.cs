...
{
    /// <summary>
    ///La Clase DALTipoUsuario sirve para la insertacion, actualizacion, eliminacion,
    ...
    class DALTipoUsuario 
    {
        ...
        /// <summary>
        /// Se trae todo los TipoUsuario de la tabla
        /// </summary>
        /// <returns></returns>
        public static List<TipoUsuario> TraerTodo()
        {
            ...
            try
            {
                using (IDataBase db = FactoryDataBase.CreateDataBase(FactoryConexion.CreateConnection()))
                {
                    ...
                    foreach (DataRow dr in ds.Tables[0].Rows)
                    {
                        ...
                        oTipoUsuario.Descripcion = dr["Descripcion"].ToString();
                        oTipoUsuario.Id = (int)dr["Id"];
                        lista.Add(oTipoUsuario);

...
namespace SeguroDeSalud.Persistencia
{
    class FactoryConexion
    {
        public static string CreateConnection()
        {
            ...
            {
                if (ConfigurationManager.ConnectionStrings[i].Name.Equals("SeguroDeSalud.Properties.Settings.Cadena", StringComparison.InvariantCultureIgnoreCase))
                    existe = true;
            }
            ...
            return ConfigurationManager.ConnectionStrings["SeguroDeSalud.Properties.Settings.Cadena"].ConnectionString;
        }
        public static string CreateConnection(string pUsuario, String pContrasena)
        {
            ...
            conexion.AppendFormat("{0}", ConfigurationManager.ConnectionStrings["SeguroDeSalud.Properties.Settings.Cadena"].ConnectionString);
            // Agrega al usuario

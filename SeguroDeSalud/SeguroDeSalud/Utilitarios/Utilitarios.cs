...
namespace SeguroDeSalud.Utilitarios
{  /// <summary>
   ...
   /// </summary>
    public class Utilitarios
    {
        ...
        /// <summary>
        /// Metodo QR para la factura
        /// </summary>
        /// <param name="pcodigo"></param>
        /// pCodigo de la factura
        /// <returns></returns>
        public static byte[] CodigoQR(int pcodigo)
        {
            ...
            qr.QRCodeErrorCorrect = QRCodeEncoder.ERROR_CORRECTION.L; // - Using LOW for more storage

            qr.QRCodeVersion = 1;

            System.Drawing.Bitmap bm = qr.Encode(pcodigo.ToString());
